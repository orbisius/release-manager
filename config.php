...
$git_bin = App_Release_Manager_File::findBinary('ogit', '/usr/bin/git');
define( 'APP_GIT_BIN', $git_bin);

$zip_bin = App_Release_Manager_File::findBinary('ozip', 'zip');
define( 'APP_ZIP_BIN', $zip_bin);
